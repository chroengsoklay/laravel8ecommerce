                            ...
                            <div class="item-content">
                                <div class="wrap-list-item social-network">
                                    <ul>
                                        ...
                                        <li><a href="{{$setting->pinterest}}" target="_blank" class="link-to-item" title="pinterest"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
                                        @endif
                                        @if($setting->twitter)
                                        <li><a href="{{$setting->twitter}}" target="_blank" class="link-to-item" title="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                        @endif
                                        @if($setting->youtube)
                                        <li><a href="{{$setting->youtube}}" target="_blank" class="link-to-item" title="youtube"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="coppy-right-box" style="margin-top: 20px;">
            <div class="container">
                <div class="coppy-right-item item-left">
                    <p class="coppy-right-text">Copyright © 2021 soklay.net. All rights reserved</p>
                </div>
