...
<body class="home-page home-01 ">
									...
									@auth 
										...
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
												...
												<li class="menu-item" >
													<a title="Home Slider" href="{{ route('admin.homeslider') }}">Mg Home Slider</a>
												</li>
												<li class="menu-item" >
													<a title="Home Category" href="{{ route('admin.homecategories') }}">Mg Home Category</a>
												</li>
												<li class="menu-item" >
												...
												<li class="menu-item" >
													<a title="All Contact" href="{{ route('admin.contacts') }}">All Contacts</a>
												</li>
												<li class="menu-item" >
													<a title="Settings" href="{{ route('admin.settings') }}">Settings</a></a>
												</li>
												<li class="menu-item" >
	...
	<script src="https://cdn.tiny.cloud/1/pj0a9fakr4nypgn2r162slxfee77h3w056xn4rcjeiwfby1o/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
