                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{route('admin.homeslider')}}" class="btn btn-primary pull-right">All Sliders</a>  
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="addslide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Sub Title" class="form-control input-md" wire:model="sub_title" />
                                </div>
                            </div>
                            <div class="form-group">
