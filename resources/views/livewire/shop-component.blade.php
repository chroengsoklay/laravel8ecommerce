                        ...
                        <div class="product product-style-3 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-wish">
                                    ...
                                    @else
                                    <a href="" wire:click.prevent="addToWishlist({{$product->id}}, '{{$product->name}}',{{$product->regular_price}})" title="add to wishlist"><i class="fa fa-heart"></i></a>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <ul class="list-category">
                        ...
                        <li class="category-item {{count($category->subCategories) > 0 ? 'has-child-cate':''}}">
                            ...
                            <ul class="sub-cate">
                                ...
                                <li class="category-item"><a href="{{route('product.category',['category_slug'=>$category->slug, 'scategory_slug'=>$subcategory->slug] )}}" class="cate-link"><i class="fa fa-caret-right"></i> {{$subcategory->name}}</a></li>
                                @endforeach
                            </ul>
                            @endif
                        </li>
