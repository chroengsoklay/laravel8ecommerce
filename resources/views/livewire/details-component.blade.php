                    ...
                    <div class="detail-info">
                        ...
                        <div>
                            @foreach($product->attributeValues->unique('product_attribute_id') as $av)
                                <div class="row" style="margin-top: 20px;"> 
                                    ...
                                    <div class="col-xs-10">
                                        <select style="width:200px;" class="form-control" wire:model="satt.{{$av->productAttribute->name}}">
                        ...
                        <div class="quantity" style="margin-top: 10px;">
                            ...
                            <div class="quantity-input">
                                <input type="text" name="product_quatity" value="1" data-max="120" pattern="[0-9]*" wire:model="qty">
                                
                                <a class="btn btn-reduce" href="#" wire:click.prevent="decreaseQuantity"></a>
                                <a class="btn btn-increase" href="#" wire:click.prevent="increaseQuanity"></a>
                            </div>
                        </div>
                        <div class="wrap-butons">
                            ...
                            <div class="wrap-btn">
                                ...
                                @else
                                <a href="" wire:click.prevent="addToWishlist({{$product->id}}, '{{$product->name}}',{{$product->regular_price}})" title="add to wishlist" class="btn btn-wishlist">Add Wishlist</a>
                                @endif
                            </div>
                        </div>
                    </div>
