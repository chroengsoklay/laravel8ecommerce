                ...
                <div class="summary-item payment-method">
                    ...
                    <div class="choose-payment-methods">
                        ...
                        <label class="payment-method">
                            ...
                            <span class="payment-desc">Order now pay with Debit or Credit Card.</span>
                        </label>
                        <!-- <label class="payment-method">
                        ...
                        @error('paymentmode') <p class="text-danger">Please select the payment method!</p> @enderror
                    </div>
                    ...
                    <div wire:ignore id="processing" style="font-size: 22px; margin-bottom: 20px; padding-left: 37px; color: green; display: none;">
                        <i class="fa fa-spinner fa-pules fa-fw"></i>
