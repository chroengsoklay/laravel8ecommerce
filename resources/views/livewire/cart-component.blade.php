    ...
    <div class=" main-content-area">
        ...
        <div class="summary">
            <div class="order-summary">
                ...
                <p class="summary-info"><span class="title">Discount Code ({{Session::get('coupon')['code']}}) <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a></span><b class="index">-${{number_format($discount,2)}}</b></p>
            ...
            <div class="checkout-info">
                @if(!Session::has('coupon'))
                    <label class="checkbox-field">
                        <input class="frm-input " name="have-code" id="have-code" value="" type="checkbox" value="1" wire:model="haveCouponCode"><span>I have coupon code</span>
                    </label>
                    @if($haveCouponCode == 1)
                    <div class="summary_item">
                        <form class="form-horizontal" wire:submit.prevent="applyCouponCode">
                            <h4 class="title-box">Coupon code</h4>
                            @if(Session::has('coupon_fail_message'))
                                <div class="alert alert-danger">
                                    <strong>Fail</strong> {{Session::get('coupon_fail_message')}}
                                </div>
                            @endif
                            <p class="row-in-form">
